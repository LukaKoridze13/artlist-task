...
- **Google OAuth** — User can sign in/up using Google account
- **Multiple generation types (Image, Text)** — User can choose between image and text
...
- **Toast notifications** — Alerts for success and error  (e.g. generation completed or failed)
- **Delete from Gallery** — User can delete anything from gallery
